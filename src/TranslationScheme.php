    ...
    public function applyProductionActions(Production $production): void
    {
        ...
        switch ($hash) {
            case SymbolType::NT_JSON_PATH . ".0":
                $pathBufferId = $symbols[0]['s.path_buffer_id'];
                var_dump("RETURN BUFFER({$pathBufferId})");
                break;

            case SymbolType::NT_PATH . ".0":
                $header['s.path_buffer_id'] = $symbols[1]['i.path_buffer_id'];
                break;

            case SymbolType::NT_DOT_FILTER_NEXT . ".0":
                $pathBufferId = $header['i.path_buffer_id'];
            ...
            case SymbolType::NT_EXPR_ARG_SCALAR . ".1":
                $pathBufferId = $header['i.path_buffer_id'];
                $inlinePathBufferId = $symbols[0]['s.path_buffer_id'];
    ...
    public function applySymbolActions(Production $production, int $symbolIndex): void
    {
        ...
        switch ($hash) {
            ...
            case SymbolType::NT_BRACKET_FILTER . ".4.2":
                $symbols[2]['i.path_buffer_id'] = $header['i.path_buffer_id'];
                break;

            case SymbolType::NT_BRACKET_FILTER . ".5.3":
                $symbols[3]['i.path_buffer_id'] = $header['i.path_buffer_id'];
                break;

            case SymbolType::NT_EXPR . ".0.0":
                $symbols[0]['i.path_buffer_id'] = $header['i.path_buffer_id'];
                break;

            case SymbolType::NT_EXPR . ".0.1":
                $symbols[1]['i.path_buffer_id'] = $header['i.path_buffer_id'];
            ...
            case SymbolType::NT_FILTER_LIST . ".2.4":
                $symbols[4]['i.path_buffer_id'] = $header['i.path_buffer_id'];
                break;
            ...
            case SymbolType::NT_DOT_FILTER_NEXT . ".1.0":
                ...
                $symbols[0]['i.path_buffer_id'] = $pathBufferId;
                break;
